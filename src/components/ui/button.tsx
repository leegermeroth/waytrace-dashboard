...
function Button({
  ...
  // Base UI defaults nativeButton to true, which logs a dev error when
  // `render` swaps in a non-button element (e.g. a RouterLink). Infer it:
  // only a real <button> render (or no render at all) is native.
